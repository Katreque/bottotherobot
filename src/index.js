...
const commandOwnerFiles = fs.readdirSync(path.resolve(__dirname, './commands/owner'))
...
const commandUserFiles = fs.readdirSync(path.resolve(__dirname, './commands/user'))
	.filter((file) => file.endsWith('.js'));
